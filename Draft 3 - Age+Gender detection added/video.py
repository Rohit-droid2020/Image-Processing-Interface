...
def main():
    ...
    sliders = [
        ...
        [
            sg.Button('Age Detection', size=(15, 1)),
            sg.Button('Gender Detection', size=(15, 1)),
            sg.Button('Emotion Detection', size=(15, 1)),
        ]
    ]
